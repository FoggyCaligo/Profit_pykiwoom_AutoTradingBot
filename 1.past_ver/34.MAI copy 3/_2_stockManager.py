...
class StockManager:
    ...
    def buy(self,price_arr,hoga_arr):
        if self.haveamount == 0:
            if(self.calc_rev(hoga_arr,price_arr)) != 0:
                ...
                self.predprice = self.price_arr[self.predict_priceidx(self.hoga_arr)]
                self.buyprice = curr_price
                return 1
            else: return 0
            pass
    ...
    def get_predprice(self):return self.predprice
    def get_buyprice(self):return self.buyprice